    ...
    <div class="list-div" id="listDiv">
        ...
        <table cellspacing="1" cellpadding="3" border="0">
            ...
            <tr class="deal-repeat">
                ...
                <?php if(is_array($CommentInfo)): foreach($CommentInfo as $key=>$info): ?><tr class="repeat">
                        ...
                        <td style="background-color: rgb(255, 255, 255);" align="right"><span><?php echo ($info["comment_time"]); ?></span></td>
            ...
            <tr>
                <td colspan="10" nowrap="true" align="right">      <!-- $Id: page.htm 14216 2008-03-10 02:27:21Z testyang $ -->
                    ...
                    <div class="page clearfix" id="pageComment">
