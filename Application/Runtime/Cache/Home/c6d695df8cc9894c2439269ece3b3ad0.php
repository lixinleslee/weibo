...
<div class="main_left">
    <ul>
        ...
        <li><a href="<?php echo U('Friend/concentrated');?>" class="selected" >关注我的</a> </li>
    </ul>
</div>
<div class="main_right">
    <div class="personal_setting"">
        ...
        <div class="info">
            <?php if(empty($userInfo)): ?><p>没有相关结果</p>
                ...
                <?php if(is_array($userInfo)): $i = 0; $__LIST__ = $userInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
                        ...
                        <?php if(empty($vo['eachOther'])): ?><dd><a href="javascript:;" class="message addFriend" name="friend" controll="<?php echo ($vo['id']); ?>">+关注<span class="loading "></span></a></dd>
                            <?php else: ?>
                            <dd><a href="javascript:;" class="message removeFriend" name="friend" controll="<?php echo ($vo['uid']); ?>">-不再关注<span class="loading "></span></a></dd><?php endif; ?>
        ...
        <div class="page clearfix" id="pageConcered">
