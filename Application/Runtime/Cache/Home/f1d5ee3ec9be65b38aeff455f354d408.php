                                                    ...
                                                    <?php switch($obj["count"]): case "0": break;?>
                                                        ...
                                                        <!--多图方案-->
                                                            ...
                                                            <div class="mutilImgSmall" >
                                                                <?php $__FOR_START_696937762__=0;$__FOR_END_696937762__=$obj["count"];for($i=$__FOR_START_696937762__;$i < $__FOR_END_696937762__;$i+=1){ ?><li class="unlog_pic" rel="<?php echo ($i); ?>"><img src="/weibo/<?php echo ($obj['images'][$i]['show']); ?>" alt="" class="piccut_v piccut_h"></li><?php } ?>
                                                            </div>
                                                            ...
                                                            <div class="mutilImgBig" style="display: none;">
                                                                ...
                                                                <div class="smallest">
                                                                    <?php $__FOR_START_1827843014__=0;$__FOR_END_1827843014__=$obj["count"];for($i=$__FOR_START_1827843014__;$i < $__FOR_END_1827843014__;$i+=1){ ?><li class="mutilImg_s" rel="<?php echo ($i); ?>"><img src="/weibo/<?php echo ($obj['images'][$i]['s']); ?>" control-data="/weibo/<?php echo ($obj['images'][$i]['middle']); ?>" source-data="/weibo/<?php echo ($obj['images'][$i]['source']); ?>" alt="" class="piccut_v piccut_h" ></li><?php } ?>
                                                                </div>
                                                            </div><?php endswitch;?>
                                                    <div class="clearBoth">
                                                    </div>
                                                                    ...
                                                                    <ul class="pic_m3 clearfix">
                                                                        <?php switch($obj['sourceContent']['count']): case "0": break;?>
                                                                            ...
                                                                            <?php default: ?>
                                                                                ...
                                                                                <div class="mutilImgSmall" >
                                                                                    <?php $__FOR_START_883392687__=0;$__FOR_END_883392687__=$obj['sourceContent']['count'];for($i=$__FOR_START_883392687__;$i < $__FOR_END_883392687__;$i+=1){ ?><li class="unlog_pic" rel="<?php echo ($i); ?>"><img src="/weibo/<?php echo ($obj['sourceContent']['images'][$i]['show']); ?>" alt="" class="piccut_v piccut_h"></li><?php } ?>
                                                                                </div>
                                                                                ...
                                                                                <div class="mutilImgBig" style="display: none;">
                                                                                    ...
                                                                                    <div class="smallest">
                                                                                        <?php $__FOR_START_1945262162__=0;$__FOR_END_1945262162__=$obj['sourceContent']['count'];for($i=$__FOR_START_1945262162__;$i < $__FOR_END_1945262162__;$i+=1){ ?><li class="mutilImg_s" rel="<?php echo ($i); ?>"><img src="/weibo/<?php echo ($obj['sourceContent']['images'][$i]['s']); ?>" control-data="/weibo/<?php echo ($obj['sourceContent']['images'][$i]['middle']); ?>" source-data="/weibo/<?php echo ($obj['sourceContent']['images'][$i]['source']); ?>" alt="" class="piccut_v piccut_h" ></li><?php } ?>
                                                                                    </div>
                                                                                </div><?php endswitch;?>
                                                                        <div class="clearBoth">
                                                                        </div>
                                            ...
                                            <div class="pic_mul">
                                                <ul class="pic_m3 clearfix">
                                                    <?php switch($obj["count"]): case "0": break;?>
                                                        ...
                                                        <?php default: ?>
                                                        <?php $__FOR_START_1689479822__=0;$__FOR_END_1689479822__=$obj["count"];for($i=$__FOR_START_1689479822__;$i < $__FOR_END_1689479822__;$i+=1){ ?><div class="mutilImgSmall">
