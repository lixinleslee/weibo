...
<link rel="stylesheet" type="text/css" href="/weibo/Public/Home/css/jquery-ui.structure.css"/>
    ...
    <link rel="stylesheet" href="/weibo/Public/Home/css/cropbox.css" type="text/css">
    ...
    <script type="text/javascript" src="/weibo/Public/Home/js/jquery.cropbox.js"></script>
...
<div class="main_right">
    <div class="personal_setting"">
        ...
        <form id="personal_form">
            ...
            <input type="text" name="username" class="text" value="<?php echo ($user['username']); ?>" id="username" readonly/>
            <br/>
            <label for="email">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：</label>
            <input type="email" name="email" class="text" id="email" placeholder="邮箱" value="<?php echo ($user['email']); ?>"/>
            <span class="star">*</span>
            <br/>
            <label for="intro" class="label_area">个人简介：</label>
            <textarea class="text area" name="intro" id="intro"><?php echo ($user['info']['intro']); ?></textarea>
            <br/>
