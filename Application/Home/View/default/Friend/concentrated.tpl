...
<div class="main_left">
    <ul>
        ...
        <li><a href="{:U('Friend/concentrated')}" class="selected" >关注我的</a> </li>
    </ul>
</div>
            ...
            <empty name="userInfo">
                ...
                <volist name="userInfo" id="vo">
                    <dl>
                        ...
                        <empty name="vo['eachOther']">
                            <dd><a href="javascript:;" class="message addFriend" name="friend" controll="{$vo['id']}">+关注<span class="loading "></span></a></dd>
                            <else/>
                            <dd><a href="javascript:;" class="message removeFriend" name="friend" controll="{$vo['uid']}">-不再关注<span class="loading "></span></a></dd>
                        </empty>
